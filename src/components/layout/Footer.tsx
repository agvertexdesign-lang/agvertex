...
export const Footer: React.FC<FooterProps> = () => {
  ...
  const contactEmail = settings?.contact?.email || 'contact@agvertex.ca';
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="space-y-3.5 text-sm text-slate-800 font-medium">
              ...
              <div className="flex items-center gap-2.5 pt-1">
                ...
                <a href="mailto:contact@agvertex.ca" className="hover:text-[#0057FF] transition-colors font-semibold">
                  contact@agvertex.ca
                </a>
              </div>
