...
export const DEFAULT_PAGE_CONTENT: WebsitePageContent = {
  ...
  about: {
    ...
    hero_img: '/images/cad_workstation_single.webp',
    ...
    exp_1_img: '/services/product_design.webp',
    ...
    exp_2_img: '/services/injection_mold.webp',
    ...
    exp_3_img: '/images/control_arm_component.webp',
    ...
    exp_4_img: '/images/cad_workstation_single.webp',
  ...
  careers: {
    ...
    hero_img: '/images/cad_team_collaboration.webp',
...
const defaultSettings: AllSettings = {
  ...
  images: {
    ...
    home_hero_image: '/images/cad_workstation_single.webp',
  },
};
